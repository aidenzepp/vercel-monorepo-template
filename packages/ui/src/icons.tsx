...
/**
 * A native SVG paint value accepted by a Fill Duo layer.
 */
type FillDuoColor = React.ComponentProps<"path">["fill"];

/**
 * Native SVG attributes with independent paints for Nucleo's two fill layers.
 */
interface FillDuoIconProps extends React.ComponentProps<"svg"> {
  /**
   * Paints the solid detail layer.
   */
  primaryColor?: FillDuoColor;
  /**
   * Paints the translucent body layer.
   */
  secondaryColor?: FillDuoColor;
}

/**
 * Displays the Nucleo badge-check Fill Duo glyph.
 *
 * @param props - The SVG presentation applied by the icon consumer.
 * @param props.className - Supplies the rendered size and contextual layout.
 * @param props.primaryColor - Paints the solid checkmark.
 * @param props.secondaryColor - Paints the translucent badge body.
 ...
 * @param props - The SVG presentation applied by the icon consumer.
 * @param props.className - Supplies the rendered size and contextual layout.
 * @param props.primaryColor - Paints the solid information mark.
 * @param props.secondaryColor - Paints the translucent circle body.
 ...
 * @param props - The SVG presentation applied by the icon consumer.
 * @param props.className - Supplies the rendered size and contextual layout.
 * @param props.primaryColor - Paints the solid warning mark.
 * @param props.secondaryColor - Paints the translucent triangle body.
 ...
 * @param props.className - Supplies the rendered size and contextual layout.
 * @param props.primaryColor - Paints the solid warning mark.
 * @param props.secondaryColor - Paints the translucent octagon body.
 * @returns The licensed Nucleo octagon-warning vector.
 * @see https://nucleoapp.com/license
 */
const OctagonWarning = ({
  className,
  primaryColor = "currentColor",
  secondaryColor = primaryColor,
  ...props
...
export { BadgeCheck, CircleInfo, OctagonWarning, TriangleWarning };
