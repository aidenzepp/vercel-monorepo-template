...
Both application layouts share the UI theme provider and mount Vercel Analytics and Speed Insights. The shared async boundary has no standalone test suite; its type and build proof comes from application consumers.
